...
def init_agent(
    ...
    max_tokens: int = None,
    hard_max_output_tokens: int = None,
    ...
    Args:
        ...
        hard_max_output_tokens (int): Optional absolute ceiling for every model response, including retries.
    ...
    agent.hard_max_output_tokens = (
        int(hard_max_output_tokens)
        if isinstance(hard_max_output_tokens, int) and hard_max_output_tokens > 0
        else None
    )
